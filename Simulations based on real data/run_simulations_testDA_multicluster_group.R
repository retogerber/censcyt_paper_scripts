# multiple cluster simulations, two covariates, test for association with censored covariate
...
for(alpha_factor in c(5)){
  ...
  saveRDS(list(alphas=alphas,sizes=sizes,cov=cov_ls), paste0(dir_save,"/",clu_name,"/af_",alpha_factor,"/res_mclu_params_af_",alpha_factor,"_",clustering,"_params_FlowCAP_group.rds"))
  ...
  saveRDS(out, paste0(dir_save,"/",clu_name,"/af_",alpha_factor,"/res_mclu_output_af_",alpha_factor,"_",clu_name,"_complete_group_",transform_fn,".rds"))
}
